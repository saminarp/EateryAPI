...
* Heroku Link: https://polar-coast-94694.herokuapp.com/
* ********************************************************************************/
...
const db = new RestaurantDB("mongodb+srv://samina:butan@cluster0.xc8rw.mongodb.net/sample_restaurants?retryWrites=true&w=majority");
...
app.get("/api/restaurants/:id",(req, res) => {
  db.getRestaurantById(req.params.id)
    .then((restaurant) => {
      if (restaurant === null) {
        res.status(404).json({ message: 'Restaurant id has already been deleted' });
        return
      }
